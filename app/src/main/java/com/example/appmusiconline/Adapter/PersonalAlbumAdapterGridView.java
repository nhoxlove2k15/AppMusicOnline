...
public class PersonalAlbumAdapterGridView extends BaseAdapter {
    Context context;
    int layout ;
    ArrayList<PersonalAlbum> arr_personal_album ;

    public PersonalAlbumAdapterGridView(Context context, int layout, ArrayList<PersonalAlbum> arr_personal_album) {
